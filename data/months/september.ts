...
export const septemberData = {
    ...
    festival: {
        name: "ମହାଳୟା",
        description: "ଆଶ୍ୱିନ ମାସ କୃଷ୍ଣପକ୍ଷ ପିତୃପକ୍ଷ ଭାବରେ ଅଭିହିତ । ଏହି ପକ୍ଷରେ ସୂର୍ଯ୍ୟ କନ୍ୟା ରାଶିରେ ଥିବାବେଳେ ଯେଉଁ ଅମାବାସ୍ୟା ପଡ଼େ ତାହା ମହାଳୟା ଅମାବାସ୍ୟା । ପୂର୍ବ-ପୁରୁଷଙ୍କ ଉଦ୍ଦେଶ୍ୟରେ ଏହି ଦିନ ଶ୍ରାଦ୍ଧ ଅର୍ପଣ କରାଯାଉଥିବାରୁ ଏହାକୁ ‘ପିତୃପର୍ବ’ ବୋଲି ମଧ୍ୟ କୁହାଯାଏ । ଆଶ୍ୱିନ ମାସର ପ୍ରତିପଦାଠାରୁ ଚତୁର୍ଦ୍ଦଶୀ ଯାଏଁ ତର୍ପଣ କଲା ପରେ ଅମାବସ୍ୟା ଦିନ ପିତୃପୁରୁଷଙ୍କ ଉଦ୍ଦେଶ୍ୟରେ ପିଣ୍ଡଦାନ କରାଯାଏ ।  ଏହି ଦିନ ଠାରୁ ଦୁର୍ଗାପୂଜାର ପ୍ରସ୍ତୁତି ମଧ୍ୟ ଆରମ୍ଭ ହୋଇଥାଏ । ଭକ୍ତମାନେ ମନ୍ଦିର ଯାଇ ମା'ଙ୍କୁ ଫୁଲ, ଦୀପ ଓ ଭୋଗ ଅର୍ପଣ କରନ୍ତି ।",
    },
    dateDetails: [
